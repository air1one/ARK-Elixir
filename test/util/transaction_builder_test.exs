defmodule ArkElixir.Util.TransactionBuilderTest do
  use ExUnit.Case, async: false
  import ArkElixir.Util.TransactionBuilder
  import Mock

  setup_with_mocks([
    {ArkElixir.Util.TransactionBuilder, [:passthrough], [seconds_since_epoch: fn() -> 27534919 end]}
  ]) do
    {
      :ok,
      [
