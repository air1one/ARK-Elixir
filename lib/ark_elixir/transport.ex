defmodule ArkElixir.Transport do
  ...
  alias ArkElixir.Models.{Block, Peer, Transaction}
  ...
  ## Examples
      ...
      iex> ArkElixir.Transport.block(client, "887102556000070987")
      {:ok, []}
  """
  ...
  ## Examples
      ...
      iex(4)> ArkElixir.Transport.blocks(client)
      {:ok, []}
  """
  ...
  ## Examples
      ...
      iex> ArkElixir.Transport.create_transactions(client, [transaction])
      {:ok,
       %{
         "success" => true,
  ...
  ## Examples
      ...
      iex> ArkElixir.Transport.transactions_from_ids(client, [id])
      {:ok, []}
  """
