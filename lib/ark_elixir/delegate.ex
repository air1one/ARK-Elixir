defmodule ArkElixir.Delegate do
  ...
  ## Examples
      ...
      iex> ArkElixir.Delegate.forged_by_account(client, "02d21954fb256662f82560cdced947af040e5190d9a08e65ee29443090499b22ec")
      {:ok,
       %{
         "fees" => "190000000",
         "forged" => "695190000000",
  ...
  ## Examples
      ...
      iex> ArkElixir.Delegate.forging_status(client, "02d21954fb256662f82560cdced947af040e5190d9a08e65ee29443090499b22ec")
      {:ok, true}
  """
  @spec forging_status(
    Tesla.Client.t(),
  ...
  ## Examples
      ...
      iex> ArkElixir.Delegate.search(client, "arkoar")
      {:ok,
       [
         %ArkElixir.Models.Delegate{
           address: "DQCZQzibtABoggT9ygSzFNQ3A7PJyxttPP",
  ...
  ## Examples
      ...
      iex> ArkElixir.Delegate.voters(client, "02d21954fb256662f82560cdced947af040e5190d9a08e65ee29443090499b22ec")
      iex(10)> ArkElixir.Delegate.voters(client, "02d21954fb256662f82560cdced947af040e5190d9a08e65ee29443090499b22ec")
      {:ok,
       [
         %ArkElixir.Models.Account{
