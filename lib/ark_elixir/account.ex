defmodule ArkElixir.Account do
  ...
  ## Examples
      ...
      iex> ArkElixir.Account.account(client, "DQCZQzibtABoggT9ygSzFNQ3A7PJyxttPP")
      {:ok,
  ...
  ## Examples
      ...
      iex> ArkElixir.Account.balance(client, "DQCZQzibtABoggT9ygSzFNQ3A7PJyxttPP")
      {:ok,
       %{
  ...
  ## Examples
      ...
      iex> ArkElixir.Account.delegates(client, "DFAVFGgkpYc4hrvUNZRf9Tpi7irWeKexLc")
      {:ok,
       [
  ...
  ## Examples
      ...
      iex> ArkElixir.Account.publickey(client, "DQCZQzibtABoggT9ygSzFNQ3A7PJyxttPP")
