defmodule ArkElixir.Middleware.Logger.Formatter do
  @moduledoc false
...
defmodule ArkElixir.Middleware.Logger do
  ...
  alias ArkElixir.Middleware.Logger.Formatter
